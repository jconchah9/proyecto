...
class PetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create petition' do
    assert_difference('Petition.count') do
      post petitions_url, params: { petition: { client_id: @petition.client_id, requerimiento: @petition.requerimiento } }
    end
  ...
  test 'should update petition' do
    patch petition_url(@petition), params: { petition: { client_id: @petition.client_id, requerimiento: @petition.requerimiento } }
