...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create sensor' do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { id_sensor: @sensor.id_sensor, type_sensor: @sensor.type_sensor } }
    end
  ...
  test 'should update sensor' do
    patch sensor_url(@sensor), params: { sensor: { id_sensor: @sensor.id_sensor, type_sensor: @sensor.type_sensor } }
