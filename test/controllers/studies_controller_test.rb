...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create study' do
    assert_difference('Study.count') do
      post studies_url, params: { study: { feasibility: @study.feasibility, petition_id: @study.petition_id, state: @study.state, summary: @study.summary } }
    end
  ...
  test 'should update study' do
    patch study_url(@study), params: { study: { feasibility: @study.feasibility, petition_id: @study.petition_id, state: @study.state, summary: @study.summary } }
