...
class AcceptancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create acceptance' do
    assert_difference('Acceptance.count') do
      post acceptances_url, params: { acceptance: { budget_id: @acceptance.budget_id, state: @acceptance.state, summary: @acceptance.summary } }
    end
  ...
  test 'should update acceptance' do
    patch acceptance_url(@acceptance), params: { acceptance: { budget_id: @acceptance.budget_id, state: @acceptance.state, summary: @acceptance.summary } }
