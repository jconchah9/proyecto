...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create sector' do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { nombre: @sector.nombre, plant_id: @sector.plant_id } }
    end
  ...
  test 'should update sector' do
    patch sector_url(@sector), params: { sector: { nombre: @sector.nombre, plant_id: @sector.plant_id } }
