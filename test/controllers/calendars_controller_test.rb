...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create calendar' do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { state: @calendar.state, study_id: @calendar.study_id, sumary: @calendar.sumary, visit_date: @calendar.visit_date } }
    end
  ...
  test 'should update calendar' do
    patch calendar_url(@calendar), params: { calendar: { state: @calendar.state, study_id: @calendar.study_id, sumary: @calendar.sumary, visit_date: @calendar.visit_date } }
